...
public class CallButtonFragment
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (i == R.id.audio_mode_speaker) {
            mode = CallAudioState.ROUTE_SPEAKER;

        } else if (i == R.id.audio_mode_earpiece || i == R.id.audio_mode_wired_headset) {// InCallCallAudioState.ROUTE_EARPIECE means either the handset earpiece,
            // or the wired headset (if connected.)
            mode = CallAudioState.ROUTE_WIRED_OR_EARPIECE;

        } else if (i == R.id.audio_mode_bluetooth) {
