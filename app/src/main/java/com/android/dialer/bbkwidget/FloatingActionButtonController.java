...
public class FloatingActionButtonController {
    ...
    private static final int FAB_SCALE_IN_DURATION = 0;
    private static final int FAB_SCALE_IN_FADE_IN_DELAY = 0;
    private static final int FAB_ICON_FADE_OUT_DURATION = 0;
    ...
    public FloatingActionButtonController(Activity activity, View container, ImageButton button) {
       ...
       //         R.integer.floating_action_button_animation_duration);
        ...
        //remove shape with bbk liupengfei
    }
