...
public RecyclerWrapAdapter(ArrayList<View> mHeaderViews, ArrayList<View> mFootViews, RecyclerView.Adapter mAdapter) {
    ...
    //Log.e("liupengfei","mHeaderViews = "+mHeaderViews.get(0));
...
public int getHeadersCount() {
	 //Log.e("liupengfei","getHeadersCount = "+mHeaderViews.size());
...
public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
	//Log.e("liupengfei","onCreateViewHolder = ");
...
public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ...
    //Log.e("liupengfei","onBindViewHolder numHeaders= "+numHeaders);
